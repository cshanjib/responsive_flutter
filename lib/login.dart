...
import 'package:responsive_flutter/constant/color.dart';
import 'package:responsive_flutter/form/custom_button.dart';
import 'package:responsive_flutter/form/custom_text_field.dart';
    ...
    return Column(
      ...
      children: [
        ...
        CustomButton(
          ...
          disabled: !_isUsernameValid() || !_isPasswordValid(),
        ),
        SizedBox(
          height: 20,
        ),
